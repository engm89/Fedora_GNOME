...
dnf install docker-ce docker-ce-cli containerd.io docker-compose-plugin vlc Thunar code libreoffice vim bash-completion firefox gconf-editor -y

# Backgrouds
dnf install f$f_Var-backgrounds-xfce f$f_Var-backgrounds-extras-xfce -y
