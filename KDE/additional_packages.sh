...
dnf install docker-ce docker-ce-cli containerd.io docker-compose-plugin vlc code libreoffice kate ark spectacle kcalc gwenview kmouth vim bash-completion firefox gconf-editor -y

# Backgrouds
dnf install f$f_Var-backgrounds-kde f$f_Var-backgrounds-extras-kde -y
